...
* @Version: 1.0.0
* @Feature List:
* -1.Delete variable definition CtrlParamMap and epoll_fd_ on qnx system
* -2.Rewrite the implementation of function Register(), Unregister(), Init(), clear(), Poll(int timeout_ms), and ThreadFunc() on qnx system
*/
